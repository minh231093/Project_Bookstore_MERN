  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='md:w-1/2 space-y-6'>
            <h2 className='text-5xl font-bold my-2 md:w-3/4 leading-snug'>Tìm sách yêu thích <span className='text-blue-700'>của bạn tại đây!</span></h2>
            <p className='mb-10 text-lg md:w-5/6 text-justify'>Hãy khám phá thế giới của tri thức và niềm đam mê đọc sách tại đây! "Sách Điện Tử Việt" tự hào mang đến cho bạn bộ sưu tập đa dạng, đáp ứng mọi sở thích và mang đến những trải nghiệm thú vị.</p>
            {/* stats */}
